...
export class BeerDetailComponent implements OnInit {
    ...
    setBreweryAndCheckinContentFromApi(beerId, breweryId) {
        Promise.all([
            this.httpService.get({ url: `${UntappdApiUrls.BeerCheckins}/${beerId}?&${UntappdApiAuth.clientAuthStr}` }),
            this.httpService.get({ url: `${UntappdApiUrls.BreweryInfo}/${breweryId}?&${UntappdApiAuth.clientAuthStr}` }),
        ])
        .then((data) => {
    ...
    getUntappdContentFromApi() {
        ...
        this.httpService
            .get({ url: `${UntappdApiUrls.BeerSearch}?q=${beerName}&${UntappdApiAuth.clientAuthStr}` })
            .then(res => {
